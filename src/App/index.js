...
export { default as Dad } from "./routes/Bikes/Dad";
export { default as Off } from "./routes/Bikes/Off";
export { default as Multi } from "./routes/Bikes/Multi";
export { default as Versatile } from "./routes/Bikes/Versatile";
